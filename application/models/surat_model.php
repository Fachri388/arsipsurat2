...
class Surat_model extends CI_Model {
	...
	public function ubah_surat_masuk_user(){
		$data = array(
			'nomor_surat' => $this->input->post('edit_no_surat_user'),
			'tgl_kirim' => $this->input->post('edit_tgl_kirim_user'),
			'tgl_terima' => $this->input->post('edit_tgl_terima_user'),
			'pengirim' => $this->input->post('edit_pengirim_user'),
			'penerima' => $this->input->post('edit_penerima_user'),
			'perihal' => $this->input->post('edit_perihal_user'),

		);
		$this->db->where('id_surat', $this->input->post('edit_id_surat_user'))
		->update('surat_masuk', $data);
	...
	public function ubah_file_surat_masuk_user($file_surat){
		$data = array(
			'file_surat' => $file_surat['file_name']
		);

		$this->db->where('id_surat', $this->input->post('edit_file_surat_user'))
		->update('surat_masuk', $data);
	...
	// surat keluar pencarian
	public function get_search_surat_keluar($keyword){
	...
	public function get_keyword($keyword){
		...
		$this->db->like('pengirim',$keyword);
		$this->db->or_like('perihal',$keyword);
		$this->db->or_like('tgl_kirim',$keyword);
		return $this->db->get()->result();
	}
