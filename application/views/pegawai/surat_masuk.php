						  ...
						  <tbody>
						  	...
						  	foreach ($data_surat_masuk as $surat_masuk) {
						  		...
						  		<tr>
						  				...
						  				<td>
						  					<a href="'.base_url('uploads/'.$surat_masuk->file_surat).'" class="btn btn-info btn-sm" target="_blank">Download</a>
						  					
						  					<a href="'.base_url('/surat/hapus_surat_masuk/'.$surat_masuk->id_surat).'" class="btn btn-danger btn-sm" >Hapus</a>
...
<div class="modal fade" id="modal_ubah_surat" tabindex="-1" role="dialog" aria-labelledby="modal_ubah_suratLabel" aria-hidden="true" data-backdrop="static" data-keyboard="false">
	<div class="modal-dialog">
		<div class="modal-content">
			...
			<form action="<?php echo base_url();?>surat/ubah_file_surat_masuk_user" method="post" enctype="multipart/form-data">
				<div class="modal-header">
				...
				<div class="modal-body">
					...
					<input type="hidden" name="edit_file_surat_user" id="edit_file_surat_user">

					
					<div class="form-group">
						<label>Unggah Surat (*pdf)</label>
						<input type="file" name="edit_file_surat_user" id="edit_file_surat_user" class="form-control">
					</div>
...
<script type="text/javascript">
        function prepare_update_surat(id_surat)
        {
            ...
            $.getJSON('<?php echo base_url(); ?>surat/get_surat_masuk_by_id/' + id_surat, function(data){
