						  ...
						  <tbody>
						  	...
						  	foreach ($data_surat_masuk as $surat_masuk) {
						  		...
						  		<tr>
						  				...
						  				<td>
						  					<a href="'.base_url('uploads/'.$surat_masuk->file_surat).'" class="btn btn-info btn-sm" target="_blank">Download/view</a>
						  					...
						  					<a href="'.base_url('surat/disposisi/'.$surat_masuk->id_surat).'" class="btn btn-primary btn-sm" >Disposisi</a>
...
<div class="modal fade" id="modal_ubah_surat" tabindex="-1" role="dialog" aria-labelledby="modal_ubah_suratLabel" aria-hidden="true" data-backdrop="static" data-keyboard="false">
	<div class="modal-dialog">
		<div class="modal-content">
			...
			<form action="<?php echo base_url();?>surat/ubah_file_surat_masuk" method="post" enctype="multipart/form-data">
				<div class="modal-header">
